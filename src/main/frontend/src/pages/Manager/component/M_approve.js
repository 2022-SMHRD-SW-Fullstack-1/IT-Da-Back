  ...
  const approveList = enter.map((item) => (
    <tr key={item.enter_id}>
      ...
      <td className="annItem_manager">
        <button
          enter_id={item.enter_id}
          onClick={enter_approve_submit}
          className="btbtbtbt"
        >
          승인
        </button>
